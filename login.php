...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?= $baseurl; ?>/login.php"> <i class="fa fa-bar-chart"></i> CV BADAK <b>TRUSS</b> </a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            ...
            <form action="" method="post">
                ...
                <div class="form-group has-feedback">
                    <button type="submit" class="btn btn-success btn-block btn-flat" name="loginBtn">Login</button>
                    <!-- /.col -->
                </div>
            </form>
        </div>
